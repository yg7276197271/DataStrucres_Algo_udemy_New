...
//Maintain two variables low and high.Initially low is 0 and high is n-1.low to high is the range of the index 
//where the elements can possibly lie.
//Take another variable mid.mid = (low+high)/2.
//If the element at mid is less than k,then the required index should obviously be between mid+1 to r,
//so make l=mid+1.
//If the element at mid is greater than k,then the required index should obviously be between l to mid-1,
//so make r=mid-1.
