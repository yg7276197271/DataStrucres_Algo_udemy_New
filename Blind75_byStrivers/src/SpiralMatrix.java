...
public class SpiralMatrix {
	// conditions are added to check if the matrix is a single column or a single row.
...
public static List<Integer> printSpiral(int[][] mat) {
        ...
        while (top <= bottom && left <= right) {
            ...
            if (top <= bottom) {  //This condition is added for single vertical line
            ...
            if (left <= right) { //This condition  is added for single horizontal column
