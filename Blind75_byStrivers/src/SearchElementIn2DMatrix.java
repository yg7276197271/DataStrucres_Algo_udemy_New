...
public class SearchElementIn2DMatrix {
	...
	//Here compare first element and last element with the one we are searching.
	//If it lies in the range then perform binary search on that row.
	//So here we are performing binary search on only one row of matrix
	...
	//here we are converting 2-d matrix to 1-d array
	...
	public static void main(String[] args) {
		...
		boolean resultUsingOnlyOneRow = searchMatrix(matrix, 26);
		System.out.println(resultUsingOnlyOneRow ? "true" : "false");
